    ...
    SECTION("to_... methods")
    {
        SECTION("json")
        {
            SECTION("xy - to json")
            {
                ...
                CHECK(p.json() == R"({"type":"Polygon","coordinates":[[[1,2],[4,5],[7,8],[1,2]],[[1,2],[4,5],[7,8],[1,2]]]})");
            }
            ...
            SECTION("xyzm - to json")
            {
                ...
                CHECK(p.json() == R"({"type":"Polygon","coordinates":[[[1,2,3,-1],[4,5,6,-5],[7,8,9,-5],[1,2,3,-1]],[[1,2,3,-1],[4,5,6,-5],[7,8,9,-5],[1,2,3,-1]]]})");
            }
        }
        ...
        SECTION("wkt")
        {
            SECTION("xy - to wkt")
            {
                ...
                CHECK(p.wkt() == "POLYGON((1 2,4 5,7 8,1 2),(1 2,4 5,7 8,1 2))");
            }
            ...
            SECTION("xyz - to wkt")
            {
                ...
                CHECK(p.wkt() == "POLYGONZ((1 2 3,4 5 6,7 8 9,1 2 3),(1 2 3,4 5 6,7 8 9,1 2 3))");
            }
