/* Generated by re2c 1.1.1 on Thu Mar 28 20:37:47 2019 */
#pragma once
        ...
        
{
	...
	if (yych <= ',') {
		...
		if (yych <= 'D') {
			...
			if (yych <= 'M') {
				if (yych <= 'E') goto shapes_wkt_lexer_17;
				if (yych <= 'L') goto shapes_wkt_lexer_4;
				goto shapes_wkt_lexer_18;
			} else {
				if (yych == 'P') goto shapes_wkt_lexer_19;
				goto shapes_wkt_lexer_4;
			}
		}
	}
...
shapes_wkt_lexer_13:
	...
	if (yych <= 'D') {
		...
		if (yych <= 'E') goto shapes_wkt_lexer_22;
		if (yych == 'e') goto shapes_wkt_lexer_22;
	}
shapes_wkt_lexer_14:
	{ return WKT_NUM; }
...
shapes_wkt_lexer_17:
	yyaccept = 1;
	yych = *(marker = ++cursor);
	if (yych == 'M') goto shapes_wkt_lexer_23;
	goto shapes_wkt_lexer_5;
shapes_wkt_lexer_18:
	yyaccept = 1;
	yych = *(marker = ++cursor);
	if (yych == 'U') goto shapes_wkt_lexer_24;
	goto shapes_wkt_lexer_5;
shapes_wkt_lexer_19:
	yyaccept = 1;
	yych = *(marker = ++cursor);
...
shapes_wkt_lexer_24:
	yych = *++cursor;
	if (yych == 'L') goto shapes_wkt_lexer_32;
	goto shapes_wkt_lexer_21;
shapes_wkt_lexer_25:
	yych = *++cursor;
	if (yych == 'I') goto shapes_wkt_lexer_33;
	goto shapes_wkt_lexer_21;
shapes_wkt_lexer_26:
	yyaccept = 0;
	yych = *(marker = ++cursor);
...
shapes_wkt_lexer_31:
	yych = *++cursor;
	if (yych == 'T') goto shapes_wkt_lexer_34;
	goto shapes_wkt_lexer_21;
shapes_wkt_lexer_32:
	yych = *++cursor;
...
shapes_wkt_lexer_35:
	yych = *++cursor;
	if (yych == 'I') goto shapes_wkt_lexer_39;
	goto shapes_wkt_lexer_21;
shapes_wkt_lexer_36:
	yych = *++cursor;
...
shapes_wkt_lexer_39:
	yych = *++cursor;
	if (yych == 'P') goto shapes_wkt_lexer_42;
	goto shapes_wkt_lexer_21;
shapes_wkt_lexer_40:
	yyaccept = 2;
	yych = *(marker = ++cursor);
	...
	if (yych == 'Z') goto shapes_wkt_lexer_47;
shapes_wkt_lexer_41:
	{ return WKT_POINT_TAGGED_TEXT; }
shapes_wkt_lexer_42:
	yych = *++cursor;
	if (yych == 'O') goto shapes_wkt_lexer_49;
	goto shapes_wkt_lexer_21;
shapes_wkt_lexer_43:
	yych = *++cursor;
	if (yybm[0+yych] & 128) {
...
shapes_wkt_lexer_47:
	yych = *++cursor;
	if (yych == 'M') goto shapes_wkt_lexer_50;
	{ return WKT_POINT_Z_TAGGED_TEXT; }
shapes_wkt_lexer_49:
	yych = *++cursor;
	if (yych == 'I') goto shapes_wkt_lexer_52;
	goto shapes_wkt_lexer_21;
shapes_wkt_lexer_50:
	++cursor;
...
shapes_wkt_lexer_52:
	yych = *++cursor;
	if (yych != 'N') goto shapes_wkt_lexer_21;
	yych = *++cursor;
	if (yych != 'T') goto shapes_wkt_lexer_21;
	yyaccept = 3;
	yych = *(marker = ++cursor);
	if (yych <= 0x1F) {
		if (yych <= '\n') {
			...
			if (yych == '\r') goto shapes_wkt_lexer_56;
		}
	} else {
		if (yych <= 'M') {
			if (yych <= ' ') goto shapes_wkt_lexer_56;
			if (yych >= 'M') goto shapes_wkt_lexer_58;
		} else {
			if (yych == 'Z') goto shapes_wkt_lexer_60;
		}
	}
shapes_wkt_lexer_55:
...
shapes_wkt_lexer_56:
	...
	if (yych <= 0x1F) {
		if (yych <= '\n') {
			if (yych <= 0x08) goto shapes_wkt_lexer_21;
...
shapes_wkt_lexer_60:
	yych = *++cursor;
	if (yych == 'M') goto shapes_wkt_lexer_62;
